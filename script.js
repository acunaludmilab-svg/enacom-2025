...
Object.assign(translations.es, {
  ...
  historyWhatTitle:
    "Un espacio federal para pensar la comunicación",
  ...
  history1983Sub:
    "Primer antecedente de articulación federal",
  ...
  history2001Title:
    "Formalización de FADECCOS",

  history2001Sub:
    "Una nueva etapa de organización institucional",
  ...
  history0210Sub:
    "El encuentro comienza a recorrer el país",
  ...
  history2020Title:
    "La pandemia transforma el encuentro",
  ...
  history2024Title:
    "San Luis es elegida sede",

  history2024Sub:
    "Preparación del XXII ENACOM",
  ...
  history2026Title:
    "XXIII ENACOM — Corrientes",

  history2026Sub:
    "La historia continúa en la UNNE",

  history2026Badge:
    "Próxima edición",

  history2026Heading:
    "Corrientes será sede del XXIII ENACOM",
...
Object.assign(translations.en, {
  ...
  historyLead:
    "A journey through the key moments that shaped the National Meeting of Communication Programs and the federal coordination of communication programs in Argentina.",

  historyWhatLabel:
    "What is ENACOM?",

  historyWhatTitle:
    "A federal space to think about communication",

  historyWhatP1:
    "The National Meeting of Communication Programs (ENACOM) brings together students, teachers, researchers, graduates and professionals linked to the field of social communication from universities across Argentina.",

  historyWhatP2:
    "Across its different editions, the meeting has become a space for academic exchange, collective knowledge production and debate about the social, cultural, political and technological transformations affecting communication.",

  history1983Title:
    "Creation of AFACOS",

  history1983Sub:
    "First precedent for federal coordination",

  history1983P1:
    "The Federal Association of Social Communication Programs (AFACOS) was created in the context of Argentina's return to democracy.",

  history1983P2:
    "The organization sought to strengthen links among communication programs through academic exchange, research, critical reflection on the media and professional training.",

  history1983P3:
    "Its creation laid part of the groundwork for the later formation of FADECCOS and the development of ENACOM.",

  history2001Title:
    "Institutionalization of FADECCOS",

  history2001Sub:
    "A new stage of institutional organization",

  history2001P1:
    "The Argentine Federation of Social Communication Programs (FADECCOS) was consolidated, continuing the process begun by AFACOS.",

  history2001P2:
    "The federation expanded representation of communication programs, strengthened exchange among universities and promoted research and national meetings linked to the field.",
  ...
  history2002P1:
    "The first National Meeting of Communication Programs was held in the city of Olavarría.",

  history2002P2:
    "The meeting emerged as a space to bring together students, teachers, researchers and graduates in social communication from different parts of the country.",

  history2002P3:
    "From this first edition onward, debates developed around media, journalism, communication policies, culture, education and technology.",

  history0210Title:
    "Federal expansion",

  history0210Sub:
    "The meeting begins to travel across the country",

  history0210P1:
    "During its early editions, ENACOM began to take place in different Argentine provinces, deepening its federal character.",

  history0210P2:
    "Participation by students and researchers grew, new discussions about the internet and digital communication appeared, and audiovisual and multimedia productions were incorporated.",

  history0210P3:
    "The meeting began to establish itself not only as a space for academic presentations, but also as a place for collective knowledge production.",
  ...
  history1019P1:
    "Technological and social transformations progressively broadened the debates present at the meeting.",

  history1019P2:
    "Social media, digital convergence, disinformation, political communication, communication rights, communication and gender, and democratization of speech became central topics.",

  history1019P3:
    "ENACOM thus accompanied changes in both the professional and academic fields of communication.",

  history2020Title:
    "The pandemic transforms the meeting",

  history2020Sub:
    "New forms of participation",

  history2020P1:
    "The COVID-19 pandemic changed in-person academic activities and forced new forms of exchange.",

  history2020P2:
    "Virtuality, digital platforms and new forms of content circulation became even more important within the field of communication.",
  ...
  history2021P1:
    "ENACOM returned to in-person meetings in Mendoza after the most critical period of the pandemic.",

  history2021P2:
    "Debates increasingly addressed the virtualization of everyday life, information overload, fake news and the role of the media during crisis situations.",

  history2024Title:
    "San Luis is chosen as host",

  history2024Sub:
    "Preparation for the 22nd ENACOM",

  history2024P1:
    "In September 2024, the FADECCOS Assembly approved the candidacy of the Faculty of Human Sciences of the National University of San Luis as host of ENACOM 2025.",

  history2024P2:
    "The selection continued the meeting's federal character and recognized the academic trajectory of the university's Social Communication program.",

  history2025Title:
    "22nd ENACOM — San Luis",

  history2025Sub:
    "Time of communication",

  history2025P1:
    "On November 5, 6 and 7, 2025, the National University of San Luis hosted the 22nd National Meeting of Communication Programs.",

  history2025P2:
    "Under the theme ‘Time of communication. Dialogues on past and present in an accelerated world,’ the edition connected the historical trajectory of the field with contemporary transformations in communication.",

  history2025P3:
    "Students, teachers, researchers, communicators, university extension workers and professionals from different provinces and Latin American countries took part.",

  history2026Title:
    "23rd ENACOM — Corrientes",

  history2026Sub:
    "The story continues at UNNE",

  history2026Badge:
    "Next edition",

  history2026Heading:
    "Corrientes will host the 23rd ENACOM",

  history2026P1:
    "On November 4, 5 and 6, 2026, the city of Corrientes will host the 23rd National Meeting of Communication Programs.",

  history2026P2:
    "The venue will be the Cabral Campus of the National University of the Northeast, with the Social Communication program of the Faculty of Humanities as host.",

  history2026P3:
    "This edition will be held under the theme:",

  history2026Quote:
    "“Thinking communication and democracy at the crossroads of the 21st century”",

  history2026P4:
    "The meeting proposes to debate contemporary challenges in communication and journalism, promoting spaces for dialogue and new lines of action in intervention, teaching and research."
});
...
Object.assign(translations.pt, {
  ...
  historyLead:
    "Um percurso pelos principais momentos que deram forma ao Encontro Nacional de Cursos de Comunicação e à articulação federal dos cursos de comunicação na Argentina.",

  historyWhatLabel:
    "O que é o ENACOM?",

  historyWhatTitle:
    "Um espaço federal para pensar a comunicação",

  historyWhatP1:
    "O Encontro Nacional de Cursos de Comunicação (ENACOM) reúne estudantes, docentes, pesquisadores, graduados e profissionais ligados ao campo da comunicação social de diferentes universidades do país.",

  historyWhatP2:
    "Ao longo de suas diferentes edições, o encontro se consolidou como um espaço de intercâmbio acadêmico, produção coletiva e debate sobre as transformações sociais, culturais, políticas e tecnológicas que atravessam a comunicação.",

  history1983Title:
    "Criação da AFACOS",

  history1983Sub:
    "Primeiro antecedente de articulação federal",

  history1983P1:
    "É criada a Associação Federal de Cursos de Comunicação Social (AFACOS), no contexto do retorno da democracia na Argentina.",

  history1983P2:
    "A organização buscou fortalecer os vínculos entre os cursos de comunicação do país por meio do intercâmbio acadêmico, da pesquisa, da reflexão crítica sobre os meios e da formação profissional.",

  history1983P3:
    "Sua criação lançou parte das bases para a posterior formação da FADECCOS e o desenvolvimento do ENACOM.",

  history2001Title:
    "Formalização da FADECCOS",

  history2001Sub:
    "Uma nova etapa de organização institucional",

  history2001P1:
    "Consolida-se a Federação Argentina de Cursos de Comunicação Social (FADECCOS), dando continuidade ao processo iniciado pela AFACOS.",

  history2001P2:
    "A federação ampliou a representação dos cursos de comunicação, fortaleceu o intercâmbio entre universidades e impulsionou pesquisas e encontros nacionais ligados ao campo.",
  ...
  history2002P1:
    "Na cidade de Olavarría é realizado o primeiro Encontro Nacional de Cursos de Comunicação.",

  history2002P2:
    "O encontro surge como um espaço destinado a reunir estudantes, docentes, pesquisadores e graduados em comunicação social de diferentes pontos do país.",

  history2002P3:
    "A partir dessa primeira edição começam a se desenvolver debates sobre meios, jornalismo, políticas de comunicação, cultura, educação e tecnologias.",

  history0210Title:
    "Expansão federal",

  history0210Sub:
    "O encontro começa a percorrer o país",

  history0210P1:
    "Durante suas primeiras edições, o ENACOM passa a ser realizado em diferentes províncias argentinas, aprofundando seu caráter federal.",

  history0210P2:
    "Cresce a participação de estudantes e pesquisadores, surgem novas discussões ligadas à internet e à comunicação digital e são incorporadas produções audiovisuais e multimídia.",

  history0210P3:
    "O encontro começa a se consolidar não apenas como espaço de exposição acadêmica, mas também como lugar de produção coletiva de conhecimentos.",
  ...
  history1019P1:
    "As transformações tecnológicas e sociais ampliam progressivamente os debates presentes no encontro.",

  history1019P2:
    "Redes sociais, convergência digital, desinformação, comunicação política, direitos comunicacionais, comunicação e gênero e democratização da palavra passam a ocupar um lugar central.",

  history1019P3:
    "O ENACOM acompanha, assim, as transformações do campo profissional e acadêmico da comunicação.",

  history2020Title:
    "A pandemia transforma o encontro",

  history2020Sub:
    "Novas formas de participação",

  history2020P1:
    "A pandemia de COVID-19 modifica as atividades acadêmicas presenciais e obriga a transformar as dinâmicas de intercâmbio.",

  history2020P2:
    "A virtualidade, as plataformas digitais e as novas formas de circulação de conteúdos ganham um papel ainda mais importante no campo da comunicação.",
  ...
  history2021P1:
    "O ENACOM volta a se encontrar presencialmente em Mendoza após o período mais crítico da pandemia.",

  history2021P2:
    "Os debates incorporam com mais força questões como a virtualização da vida cotidiana, a sobreinformação, as notícias falsas e o papel dos meios em situações de crise.",

  history2024Title:
    "San Luis é escolhida como sede",

  history2024Sub:
    "Preparação do XXII ENACOM",

  history2024P1:
    "Em setembro de 2024, a Assembleia da FADECCOS aprova a candidatura da Faculdade de Ciências Humanas da Universidade Nacional de San Luis como sede do ENACOM 2025.",

  history2024P2:
    "A escolha dá continuidade ao caráter federal do encontro e reconhece a trajetória acadêmica do curso de Comunicação Social da universidade.",
  ...
  history2025P1:
    "Nos dias 5, 6 e 7 de novembro de 2025, a Universidade Nacional de San Luis sediou o XXII Encontro Nacional de Cursos de Comunicação.",

  history2025P2:
    "Sob o lema ‘Tempo de comunicação. Diálogos sobre passado e presente em um mundo acelerado’, a edição colocou em diálogo a trajetória histórica do campo com as transformações contemporâneas da comunicação.",

  history2025P3:
    "Participaram estudantes, docentes, pesquisadores, comunicadores, extensionistas e profissionais de diferentes províncias e países latino-americanos.",

  history2026Title:
    "XXIII ENACOM — Corrientes",

  history2026Sub:
    "A história continua na UNNE",

  history2026Badge:
    "Próxima edição",

  history2026Heading:
    "Corrientes será sede do XXIII ENACOM",

  history2026P1:
    "Nos dias 4, 5 e 6 de novembro de 2026, a cidade de Corrientes receberá o XXIII Encontro Nacional de Cursos de Comunicação.",

  history2026P2:
    "A sede será o Campus Cabral da Universidade Nacional do Nordeste, com o curso de Comunicação Social da Faculdade de Humanidades como anfitrião.",

  history2026P3:
    "Esta edição será realizada sob o lema:",

  history2026Quote:
    "“Pensar a comunicação e a democracia nas encruzilhadas do século XXI”",

  history2026P4:
    "O encontro propõe debater os desafios contemporâneos da comunicação e do jornalismo, promovendo espaços de diálogo e novas linhas de ação em intervenção, docência e pesquisa."
});
...
if (
  localStorage.getItem("enacom-contrast") ===
  "true"
) {
...
function renderQuestion(
  ...
  quizPrevious.textContent =
    labels.previous;

  quizPrevious.disabled =
    currentQuestion === 0;
